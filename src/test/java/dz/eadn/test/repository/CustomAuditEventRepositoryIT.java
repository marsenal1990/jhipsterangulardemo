package dz.eadn.test.repository;

import dz.eadn.test.JhipsterangularsampleApp;
import dz.eadn.test.config.Constants;
import dz.eadn.test.config.audit.AuditEventConverter;
import dz.eadn.test.domain.PersistentAuditEvent;
...
import static dz.eadn.test.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
